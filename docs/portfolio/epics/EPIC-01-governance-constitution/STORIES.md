...
### S-01-014 — Foundation transfer plan RFC (RFC-0002)
As the program lead I want the foundation transfer plan captured as RFC-0002 so that Phase-2 neutrality is credible and pre-committed.
- AC: shortlist of 3 candidate foundations; ordered timeline states (not dates); IP-transfer clause drafted
- Meta: Shard=I | Type=RFC | Size=L | Prio=P1 | Status=DRAFT | SKU=★ | PRD=— | Const=C-06,C-OA
